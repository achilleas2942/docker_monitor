...
def get_docker_stats():
    ...
    while not rospy.is_shutdown():
        for container in containers:
            ...
            # Define the publisher inside the loop to prevent using 'container' before it's defined
            pub = rospy.Publisher("docker_stats/" + container.name, DockerStats, queue_size=10)
            pub.publish(msg)
